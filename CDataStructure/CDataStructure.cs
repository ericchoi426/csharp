...
namespace CDataStructure
{
    ...
    class CDataStructure
    {
        static void Main(string[] args)
        {
            ...
            CDSHelper.PrintFormattedString();

            #region [ example of between ]
            {
                String text = "One=1,Two=2,ThreeFour=34";

                Console.WriteLine(CDSHelper.betweenStrings(text, "One=", ",")); // 1
                Console.WriteLine(CDSHelper.betweenStrings(text, "Two=", ",")); // 2
                Console.WriteLine(CDSHelper.betweenStrings(text, "ThreeFour=", "")); // 34
            }
            #endregion

            #region [ example of GetDecimal ]
            {
                string strDel = CDSHelper.GetDecimal("123adkdi67dkdkdkdk7d88888a", " ");
